...
parser.add_opt_argument_list('--lr_1', default=0.001, options=[0.0001, 0.0002, 0.0004, 0.0008, 0.001, 0.002], type=float, tunnable=True)
parser.add_opt_argument_list('--batch_size', default=100, options=[20, 30, 40, 50], type=int, tunnable=True)
...
parser.add_argument('--eval_every_n_batches', default=5, type=int)
...
parser.add_argument('--dataset_train_path', default='enron/train.csv')
parser.add_argument('--dataset_test_path', default='enron/test.csv')
parser.add_argument('--dataset_val_path', default='enron/val.csv')
parser.add_argument('--vocab_path', default='enron/vocabulary.txt')

parser.add_argument('--model_save_dir', default='save_model')
parser.add_argument('--test_tube_dir', default='save_model')
