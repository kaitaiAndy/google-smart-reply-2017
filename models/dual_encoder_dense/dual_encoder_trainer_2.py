...
def train_main(hparams):
    ...
    print(context_embedding_summed)
    # ----------------------
    ...
    #saver = tf.train.import_meta_graph('save_model/dual_conv_dense/epoch_6/model.cpkt.meta')
    #saver.restore(sess, "save_model/dual_conv_dense/epoch_6/model.cpkt")
...
def evaluate_recall(y, y_test, k=1):
    # y is the score for each response, y_test is the true response
